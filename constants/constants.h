...
inline const int CONNECT_BUTTON_OFFSET_X = PARENT_MARGIN_X + WIFI_SCAN_BUTTON_WIDTH + BUTTON_X_SPACING_MARGIN;
...
inline const int FORGET_BUTTON_OFFSET_X = CONNECT_BUTTON_OFFSET_X + WIFI_SCAN_BUTTON_WIDTH + BUTTON_X_SPACING_MARGIN;
...
inline const int HELP_BUTTON_OFFSET_X = PARENT_MARGIN_X + ENABLE_BUTTON_WIDTH + BUTTON_X_SPACING_MARGIN;
